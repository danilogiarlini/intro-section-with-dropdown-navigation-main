...
const NavBar = () => {
  ...
  const FeaturesDropdownHandler = (event) => {
  ...
  return (
    <nav className="App-header">
      <svg id="snap" width="84" height="27" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      <ul className="links">
        <li>
          <a href="#" onClick={FeaturesDropdownHandler}>
            Features
          </a>
          {featuresDropdownOpen && <FeaturesDropdown />}
        ...
        <li>
          <a href="#" onClick={CompanyDropdownHandler}>
            Company
          </a>
          {companyDropdownOpen && <CompanyDropdown />}
          {companyDropdownOpen || (
            <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg">
              <path
                stroke="#686868"
